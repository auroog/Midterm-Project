...
logging.basicConfig(level=logging.INFO, 
                    ...
                    handlers=[logging.FileHandler("calculator_history.log"),
...
class HistoryManager:
    ...
    def add_to_history(self, operation: str, operand_a: float, operand_b: float, result: float) -> None:
        ...
        logging.info(f'Added to history: {operation}({operand_a}, {operand_b}) = {result}')
